...
execution_strategy = {
    ...
    "knobs": {
        ...
        "tieredCompilationEnabled": (0, 1),  # default true
        "backgroundCompilationEnabled": (0, 1),  # default is on, but introduces multi-threading variance
        ...
        "compileThreshold": (1000, 50000),  # 2000-50000 default 10000
        "onStackReplacePercentage": (144, 993),
    }
}
